...
<body>
    ...
    <div class="vertical-toolbar1">
        ...
        <button><a href="ChefS_List_etu_M2.php">Liste des etudiants</a></button>
    ...
    <!-- Home -->
    <div class="Home">
        <button><a href="ChefS_Liste_Theme_nom_valide_M2.php"> Themes non valide </a></button>
        <button><a href="Liste_Theme_M2.php">Liste des themes</a></button>
    </div>
